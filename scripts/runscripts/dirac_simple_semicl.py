...
def dirac():
    ...
    dirac_curvat = sbe.dipole.SymbolicCurvature(h_sym, dirac_dipole.Ax, dirac_dipole.Ay)

    return dirac_system, dirac_dipole, dirac_curvat
...
def run(system, dipole, curvat):
    ...
    sbe_solver(system, dipole, params, curvature=curvat)
