...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{phase=variable_E_dir_plot.pdf}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{phase=variable_E_dir_split_plot.pdf}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{phase=variable_ortho_plot.pdf}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{phase=variable_ortho_split_plot.pdf}
    \caption{This plot is a repetition of \cref{fig:sec1_orthogonal_screening} with individual color
      ...
      (b): $I_{\mathrm{hh}}^{\mathrm{max}} = \SI{9.8286e-37}{[\atomicunits]}$ and (c): 
      $I_{\mathrm{hh}}^{\mathrm{max}} = \SI{4.4658e-37}{[\atomicunits]}$.}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{phase=variable_full_plot.pdf}
    \caption{Screening plot of phase against frequency. The maximum intensity orthogonal
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{phase=variable_full_split_plot.pdf}
