...
\begin{align}
    j_{\parallel\bE}(t) = \hat{e}_\phi\;\bj(t)\,,\hspace{2em}
    j_{\bot\bE}(t) = \hat{e}_{\phi+\pi/2}\;\bj(t)\,, 
    \label{currentcomp}
\end{align}
such that we recover $\bj(t)\eqt\hat{e}_\phi\, j_{\parallel\bE}(t)\pt\hat{e}_{\phi+\pi/2}\,j_{\bot\bE}(t)$.
