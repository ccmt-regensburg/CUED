...
%
The BZ and a smaller PH-SMALLNK1\,$\times$\,PH-SMALLNK2 $k$-point mesh is sketched in Fig.~\ref{fig:kp}.
%
...
\input{BZ.tikz}
\vspace{-1em}
\caption{Brillouin zone (BZ) and PH-NK1SMALL\,$\times$\,PH-NK2SMALL $k$-point mesh.
%
